...
```{r table}#, echo = FALSE}
factors = c("Høyde(H)", "Innhold(I)", "Str(S)")
factorlabs = c("H", "I", "S")
table <-matrix(c("Høyt", "Lavt", "Hel", "Halv", "Stor", "Liten"), 2, 3, dimnames = list(c(1, -1), factors))
kable(table)
```
